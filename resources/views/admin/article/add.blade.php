...
<div class="main_content">
    <form id="ajaxForm" role="form" method="POST" action="{{url('admin/article')}}">
        {{csrf_field()}}
        <div class="row">
            <div class="col-sm-offset-1 col-sm-3 col-md-2">
                <div class="form-group form-group-sm">
                    <label for="cate_id"><i class="require">*</i>{{ trans('category.cate_type') }} <span class="cate_id error"></span></label>
            ...
            <div class="col-sm-4">
                <div class="form-group form-group-sm">
                    <label for="article_title"><i class="require">*</i>{{ trans('article.article_title') }}</label><span class="article_title error"></span>
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-11">
                <div class="form-group form-group-sm">
                    <label for="article_content"><i class="require">*</i>{{ trans('article.article_content') }}</label><span class="article_content error"></span>
        ...
        <div class="form-group form-group-sm col-sm-offset-1">
            <label for="article_thumb" class="">{{ trans('article.article_thumb') }}</label><span class="article_thumb error"></span>
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-xs-9">
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-4">
                <div class="form-group form-group-sm">
                    <label for="article_author">{{ trans('article.article_author') }}</label><span class="article_author error"></span>
                    <input id="article_author" type="text" class="form-control" name="article_author">
                </div>
                <div class="form-group form-group-sm">
                    <label for="article_keywords">{{ trans('article.article_keywords') }}</label><span class="article_keywords error"></span>
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-7 col-md-6">
                <div class="form-group form-group-sm">
                    ...
                    <span class="article_description error"></span>
